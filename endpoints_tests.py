...
def test_1_post_new_client():
    ...
    response = requests.post(f"{BASE_URL}/api/v1/clients/", 
...
def test_3_put_update_client():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/clients/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_3_put_update_inventory():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/inventories/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_1_post_new_item_group():
    ...
    response = requests.post(f"{BASE_URL}/api/v1/item_groups/", 
                           headers={"Authorization": f"Bearer {API_KEY}", 
                                  "Content-Type": "application/json"}, 
                           json=data)
    assert response.status_code == 201
...
def test_3_put_update_item_group():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/item_groups/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_1_post_new_item_line():
    ...
    response = requests.post(f"{BASE_URL}/api/v1/item_lines/", 
                           headers={"Authorization": f"Bearer {API_KEY}", 
                                  "Content-Type": "application/json"}, 
                           json=data)
    assert response.status_code == 201
...
def test_3_put_update_item_line():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/item_lines/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_3_put_update_location():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/locations/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_3_put_update_order():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/orders/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_1_post_new_item():
    ...
    response = requests.post(f"{BASE_URL}/api/v1/items/", 
                           headers={"Authorization": f"Bearer {API_KEY}", 
                                  "Content-Type": "application/json"}, 
                           json=data)
    assert response.status_code == 201
...
def test_3_put_update_item():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/items/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
...
def test_1_post_new_warehouse():
    ...
    response = requests.post(f"{BASE_URL}/api/v1/warehouses/", 
                           headers={"Authorization": f"Bearer {API_KEY}", 
                                  "Content-Type": "application/json"}, 
                           json=data)
    assert response.status_code == 201
...
def test_3_put_update_warehouse():
    ...
    response = requests.put(f"{BASE_URL}/api/v1/warehouses/{TEST_ID}/", 
                          headers={"Authorization": f"Bearer {API_KEY}", 
                                 "Content-Type": "application/json"}, 
                          json=data)
    assert response.status_code == 200
